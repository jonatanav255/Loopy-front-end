...
export function GapMarking({ result, onDone }: GapMarkingProps) {
  return (
    <div className="mx-auto max-w-2xl">
      <h3 className="text-lg font-semibold text-gray-900">Teach-Back Complete</h3>
      <p className="mt-1 text-sm text-gray-600">{result.conceptTitle}</p>

      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        <div className="rounded-lg border border-gray-200 bg-white p-4">
          <p className="text-sm font-medium text-gray-700">Self Rating</p>
          <p className="mt-1 text-3xl font-bold text-indigo-600">{result.selfRating}/5</p>
        </div>
        <div className="rounded-lg border border-gray-200 bg-white p-4">
          <p className="text-sm font-medium text-gray-700">Gaps Found</p>
      ...
      {result.gapsFound.length > 0 && (
        <div className="mt-4 rounded-lg bg-orange-50 p-4">
          <p className="mb-2 text-sm font-medium text-orange-700">Knowledge Gaps</p>
