...
export function GapMarking({ result, onDone }: GapMarkingProps) {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <h3 className="text-lg font-semibold text-content">{t.teachBack.complete}</h3>
      ...
      {result.gapsFound.length > 0 && (
        <div className="mt-4 rounded-lg bg-orange-500/10 p-4">
          <p className="mb-2 text-sm font-medium text-orange-300">{t.teachBack.knowledgeGaps}</p>
